...
interface PurchasingDocumentLayoutProps {
    type: 'PO' | 'RECEIPT' | 'BILL';
    title: string;
    onClose: () => void;
    onSave: () => void;
...
export default function PurchasingDocumentLayout({
    type,
    title,
    onClose,
    onSave,
    ...
    const typeLabels = {
        PO: t('new_po'), // Fallback to New PO if specific title not provided, but usually overridden
        RECEIPT: t('new_receipt'),
        BILL: t('new_bill'),
    };

    // More specific labels for the small uppercase sub-header
    const typeSubLabels = {
        PO: t('new_po'),
        RECEIPT: t('new_receipt'),
        BILL: t('new_bill'),
