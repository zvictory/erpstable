...
export function VendorMoneyBar({
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-4 w-full bg-white border border-slate-200 divide-x divide-slate-200">
            ...
            <div className="p-4 border-t-4 border-t-[#0077c5] hover:bg-slate-50 transition-colors cursor-pointer group">
                <div className="flex justify-between items-start mb-1">
                    <span className="text-xs font-semibold text-slate-500 uppercase tracking-wide group-hover:text-[#0077c5] transition-colors">Open POs</span>
            ...
            <div className="p-4 border-t-4 border-t-[#f27020] hover:bg-slate-50 transition-colors cursor-pointer group">
                <div className="flex justify-between items-start mb-1">
                    <span className="text-xs font-semibold text-slate-500 uppercase tracking-wide group-hover:text-[#f27020] transition-colors">Overdue</span>
            ...
            <div className="p-4 border-t-4 border-t-slate-400 hover:bg-slate-50 transition-colors cursor-pointer group">
                <div className="flex justify-between items-start mb-1">
                    <span className="text-xs font-semibold text-slate-500 uppercase tracking-wide group-hover:text-slate-600 transition-colors">Open Bills</span>
            ...
            <div className="p-4 border-t-4 border-t-[#2ca01c] hover:bg-slate-50 transition-colors cursor-pointer group">
                <div className="flex justify-between items-start mb-1">
                    <span className="text-xs font-semibold text-slate-500 uppercase tracking-wide group-hover:text-[#2ca01c] transition-colors">Paid (30 Days)</span>
